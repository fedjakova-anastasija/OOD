...
CTextAndImageEditor::CTextAndImageEditor()
	: m_document(std::make_unique<CDocument>())
{
}

void CTextAndImageEditor::Run()
{
	Help(std::cin);
...
void CTextAndImageEditor::AddParagraph(std::istream& input)
{
	std::string text;
	std::string position;
...
void CTextAndImageEditor::AddImage(std::istream& input)
{
	int width = 0;
	int height = 0;
	std::string path;
...
void CTextAndImageEditor::SetTitle(std::istream& input)
{
	std::string title;
...
void CTextAndImageEditor::Delete(std::istream& input)
{
	size_t index;
	if (!(input >> index))
	{
...
void CTextAndImageEditor::Help(std::istream&)
{
